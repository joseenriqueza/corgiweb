...
spiders["foxnews_com"] = corgi.crawler.crawler.Crawler(domain="foxnews.com",  # Website domain address
...
spiders["walmart_com"] = corgi.crawler.crawler.Crawler(domain="walmart.com",  # Website domain address
                 user_agent= "*",  # User-Agent used to call the website
...
data = corgi.data_and_queue.data_domain.DataAccess()
data.start_django()
for k, v in spiders.items():
    v.start_bfs()
